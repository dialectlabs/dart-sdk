...
class DialectDto {
  ...
  bool operator ==(covariant DialectDto other) {
    // print(ListEquality().equals(members, other.members));
    // if (!ListEquality().equals(members, other.members)) {
    //   print(members.map((e) => e.toJson()));
    //   print(other.members.map((e) => e.toJson()));
    // }
    return ListEquality().equals(members, other.members) &&
...
class MemberDto {
  ...
  bool operator ==(covariant MemberDto other) {
    return ListEquality().equals(scopes, other.scopes) &&
